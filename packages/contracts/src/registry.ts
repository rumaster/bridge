import { C4_VERSION } from "./c4.js";
import { C5_VERSION } from "./c5.js";
import { C6_VERSION } from "./c6.js";
import { C7_VERSION } from "./c7.js";
import { C8_VERSION } from "./c8.js";
import { C9_VERSION } from "./c9.js";
import { C10_VERSION } from "./c10.js";
import {
  MESSAGE_MODEL_CONTRACT_ID,
  MESSAGE_MODEL_VERSION,
} from "../message-model/index.js";
import { MOBILE_API_VERSION } from "./mobile.js";
...
export const M0_CONTRACT_REGISTRY = Object.freeze([
  freezeContract({
    ...
    artifacts: [
      ...
      "packages/contracts/message-model/index.ts",
    ],
...
export const CP1_CONTRACT_FREEZE = Object.freeze([
  freezeContract({
    ...
    dtoNames: ["C1.CanonicalMessage"],
    evidence: [
      "packages/contracts/message-model/message-model.test.ts",
  ...
  freezeContract({
    ...
    evidence: [
      "tests/contract/int-core.c2.contract.test.ts",
      "tests/contract/int-core-c2-c6.test.ts",
  ...
  freezeContract({
    ...
    evidence: [
      "tests/contract/manager-workspace-c3-consumer.test.ts",
      "tests/contract/saas-admin-c3-consumer.test.ts",
  ...
  freezeContract({
    ...
    dtoNames: ["C7.WebSocketEvent"],
    evidence: ["packages/contracts/test/unit/c7-websocket-event-schema.test.ts"],
  }),
]);
...
export const CP2_CP3_CONTRACT_FREEZE = Object.freeze([
  freezeContract({
    ...
    evidence: [
      "tests/contract/int-core-m2-adapters.contract.test.ts",
      "tests/contract/int-core-c2-c6.test.ts",
      "services/backend/test/integration/internal-messaging.spec.ts",
      "services/backend/test/unit/internal-messaging.dto.spec.ts",
      "tests/e2e/backend-dist-communication-core.test.ts",
  ...
  freezeContract({
    ...
    evidence: [
      "tests/contract/c4-ai-contract.test.ts",
      "tests/contract/ai-integration-c4-consumer.test.ts",
      "tests/contract/manager-workspace-c4-c7-consumer.test.ts",
      "tests/e2e/ai-assistant-kb.test.ts",
      "tests/integration/ai-rag-kb.test.ts",
      "services/backend/test/unit/ai-integration.facade.spec.ts",
      "services/ai-platform/test/unit/rag-pipeline.test.ts",
      "services/ai-platform/test/integration/rag-assistant-server.test.ts",
    ],
  }),
]);
