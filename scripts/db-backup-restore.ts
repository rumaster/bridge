...
function usage() {
  return [
    "Usage:",
    "  node scripts/db-backup-restore.ts backup --database-url <url> --file <dump> [--target app|rf]",
    "  node scripts/db-backup-restore.ts restore --database-url <url> --file <dump> [--clean] [--target app|rf]",
    "  node scripts/db-backup-restore.ts probe --source-url <url> --restore-url <url> --file <dump> [--target app|rf]",
  ].join("\n");
}
