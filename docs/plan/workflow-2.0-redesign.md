...
- Узел `llm` по-прежнему без эндпоинта: у ai-platform нет RPC под сырой completion, и его добавление — расширение контракта C4 и чужого сервиса. Вынесено отдельно.
