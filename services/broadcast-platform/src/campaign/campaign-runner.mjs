import { createBroadcastStateChangedEvent } from "../../../../packages/contracts/src/c8.mjs";

import { buildBroadcastDraft } from "./campaign-message-factory.mjs";
import {
  channelSupportsType,
  resolveChannelRateLimit,
} from "./channel-capability.mjs";
import { createBroadcastRateLimiter } from "./broadcast-rate-limiter.mjs";
import { createBroadcastBackoff } from "./broadcast-backoff.mjs";
import { createBroadcastStats } from "./broadcast-stats.mjs";
...
export function createCampaignRunner({
   ...
   * @param {import("./campaign-message-factory.mjs").CampaignRecipient[]} recipients
