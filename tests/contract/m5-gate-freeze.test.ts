...
import { M0_GATE_REQUIRED_CONTRACT_IDS } from "../../packages/contracts/src/registry.js";
...
describe("M5-99 integration gate — CP-9 final v1 freeze", () => {
  ...
  it("binds each §26.6 acceptance scenario to a passing e2e file", () => {
    const gateEvidence = [
      ...
      "tests/e2e/workflow-engine-cp4-cp5.test.ts",
      "tests/e2e/workflow-fbp-m5-cp9.test.ts",
      "tests/e2e/ai-onboarding-apply.test.ts",
      // Notification / Broadcast
      "tests/e2e/notification-delivery-cp9.test.ts",
      "tests/e2e/telegram-console-cp8.test.ts",
      "tests/e2e/broadcast-delivery-cp6.test.ts",
      // Edge Cluster / Потеря соединения
      "services/edge-gateway/test/unit/edge-cluster.test.ts",
