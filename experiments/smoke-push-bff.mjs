 ...
 * Запуск: node experiments/smoke-push-bff.mjs
 */
import assert from "node:assert/strict";

import { createMobileBff } from "../services/mobile-api/src/mobile-bff.mjs";
import { createMockBackendApi } from "../services/mobile-api/src/backend-client.mjs";
import { createDeviceRegistry } from "../services/mobile-api/src/device-registry.mjs";
import { createMockPushProvider } from "../services/mobile-api/src/push-provider.mjs";
import { createPushDispatcher } from "../services/mobile-api/src/push-dispatcher.mjs";
